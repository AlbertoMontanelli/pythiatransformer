...
class Particle_Transformer(nn.Module):
    '''
        commentino della classe
        nn.module è una classe di torch per tutti i tipi di reti neurali, contiene delle subclassi come la classe transformer
    ...
    def __init__(self,
        ...
        Args: 
            ...
            N_head (int): number of heads used for the attention mechanism (min 6)
