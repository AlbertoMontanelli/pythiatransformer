...
events = ak.Array([
    {"feature1": [1.0, 2.0], "feature2": [0.1, 0.2], "feature 3": [-11, -55], "feature 4": [11, 55]},  # Evento 1
    {"feature1": [3.0], "feature2": [0.3], "feature 3": [-45], "feature 4": [35]} , # Evento 2
...
def tensor_convertion(events, selected_features):
    ...
    padded_events = {
        feature: ak.fill_none(ak.pad_none(events[feature], target=max_particles, axis=1), 0)
...
print(tensor.shape)  # Output: torch.Size([num_events, max_particles, num_features])
